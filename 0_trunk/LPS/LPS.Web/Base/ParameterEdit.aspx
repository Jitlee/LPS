<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ParameterEdit.aspx.cs" Inherits="LPS.Web.Base.ParameterEdit" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    $(document).ready(function () {
	        $("#txtParamValue").yz({ title: "值", type: "string", max: 20, canEmpty: false, isSave: true });
	    });
	</script>
</head>
<body>
						...
						<div id="pageBody" style="padding: 15px;">
							<table class="tableOneline" border="0" cellpadding="0" cellspacing="1">
								<tr>
									...
									<td class="tdLeft">
										<asp:Label runat="server" Width="200px" ID="lblParamName" CssClass="textbox_skin" />
									</td>
								</tr>
								<tr>
									<td class="tdRight">
									...
									<td class="tdLeft">
										<asp:Label runat="server"  Width="200px" ID="lblParamDesc" CssClass="textbox_skin" />
									</td>
								</tr>
								<tr>
									<td class="tdRight">
									...
									<td class="tdLeft">
										<asp:TextBox runat="server" ID="txtParamValue"  Width="200px" CssClass="textbox_skin" />
									</td>
								</tr>
							</table>
						</div>
