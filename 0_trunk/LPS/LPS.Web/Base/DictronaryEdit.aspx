<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DictronaryEdit.aspx.cs" Inherits="LPS.Web.Base.BaseDictronaryEdit" %>
...
<tr><td class="tdRight">：</td><td class="tdLeft" > <asp:TextBox  runat="server" ID="txtDictType" CssClass="textbox_skin" /> </td></tr>
<tr><td class="tdRight">：</td><td class="tdLeft" > <asp:TextBox  runat="server" ID="txtDictName" CssClass="textbox_skin" /> </td></tr>
<tr><td class="tdRight">：</td><td class="tdLeft" > <asp:TextBox  runat="server" ID="txtDictValue" CssClass="textbox_skin" /> </td></tr>
<tr><td class="tdRight">：</td><td class="tdLeft" > <asp:TextBox  runat="server" ID="txtDictDesc" CssClass="textbox_skin" /> </td></tr>
