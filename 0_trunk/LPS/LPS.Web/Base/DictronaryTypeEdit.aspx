<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DictronaryTypeEdit.aspx.cs" Inherits="LPS.Web.Base.BaseDictronaryTypeEdit" %>
...
<tr><td class="tdRight">：</td><td class="tdLeft" > <asp:TextBox  runat="server" ID="txtDictTypeName" CssClass="textbox_skin" /> </td></tr>
<tr><td class="tdRight">：</td><td class="tdLeft" > <asp:TextBox  runat="server" ID="txtDictTypeDesc" CssClass="textbox_skin" /> </td></tr>
